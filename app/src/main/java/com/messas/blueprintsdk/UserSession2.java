...
public class UserSession2 {
    ...
    private static final String PREF_NAME = "UserSessionPref1";

    // First time login Check
    public static final String FIRST_TIME = "firsttime1";
    ...
    public static final String KEY_MOBiLE = "mobile1";

    // user avatar (make variable public to access from outside)
    public static final String KEY_PHOTO = "photo1";
    public static final String Username = "username1";


    // number of items in our cart
    public static final String KEY_CART = "cartvalue1";

    // number of items in our wishlist
    public static final String KEY_WISHLIST = "wishlistvalue1";

    // check first time app launch
    public static final String IS_FIRST_TIME_LAUNCH = "IsFirstTimeLaunch1";

    private FirebaseFirestore firebaseFirestore;


    // Constructor
    public UserSession2(Context context){
    ...
    public ArrayList<Long> getWishlist(final LottieAnimationView view){
        ...
        String usermobile = this.getUserDetails().get(UserSession2.KEY_MOBiLE);
        String username = this.getUserDetails().get(UserSession2.KEY_NAME);
