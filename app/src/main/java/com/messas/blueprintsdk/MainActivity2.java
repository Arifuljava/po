...
// Create a BroadcastReceiver for ACTION_FOUND
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        init();
        bottomSheetDialog11 = new BottomSheetDialog(MainActivity2.this);
        ...
        session = new UserSession(MainActivity2.this);
        scason2 = new UserSession2(MainActivity2.this);
        //default value
...
//for devices
       ...
       // deviceAdapter = new BluetoothDeviceAdapter(this, new ArrayList<>());
                ...
                if (BluetoothDevice.ACTION_FOUND.equals(action)) {
                    ...
                    if (device != null && device.getName() != null && device.getAddress() != null) {
                        ...
                        if (!deviceList.contains(deviceInfo)) {
                            ...
                            Toast.makeText(MainActivity2.this, "New device: " + deviceInfo, Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(MainActivity2.this, "Duplicate device: " + deviceInfo, Toast.LENGTH_SHORT).show();
                        }
                    }
                }
            }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(MainActivity2.this, "Clicked: " + selectedItem, Toast.LENGTH_SHORT).show();
            }
        });
      ...
      */
        ...
        searchagain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                discoverDevices();
                Dialog mDialouge = new Dialog(MainActivity2.this);
        ...
        relagoo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                deviceAdapter = new BluetoothDeviceAdapter(MainActivity2.this, new ArrayList<>());
                deviceAdapter = new BluetoothDeviceAdapter(MainActivity2.this, new ArrayList<>());
                listView = (ListView) bottomSheetDialog11.findViewById(R.id.list_view);
                listView.setAdapter(deviceAdapter);
                startDiscovery();
...
//for devices
        ...
        printcommand.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ((TextUtils.isEmpty(name) || name.toString() == null) && (TextUtils.isEmpty(mobile) || mobile.toString() == null)) {
                    Toast.makeText(MainActivity2.this, "No printer Connected.", Toast.LENGTH_SHORT).show();
                } else {
                    if ((name.toString().equals("THT")|| name.toString().contains("THT")) && ( mobile.toString().equals("01:01:01:01:01"))) {
                        ...
                        if (!mBluetoothAdapter.isEnabled()) {
                            ...
                            android.app.AlertDialog.Builder mybuilder = new android.app.AlertDialog.Builder(MainActivity2.this);
    ...
    private void init()
    {
        ...
        if (bluetoothAdapterq.isEnabled()) {
            if (ContextCompat.checkSelfPermission(MainActivity2.this, Manifest.permission.BLUETOOTH_CONNECT)
    ...
    private void alldevice() {
        //Toast.makeText(this, ""+mobile, Toast.LENGTH_SHORT).show();
      //  Toast.makeText(this, "JKKKK", Toast.LENGTH_SHORT).show();
        deviceList = new ArrayList<>();
        deviceListAdapter = new ArrayAdapter<>(this,
                android.R.layout.simple_list_item_1, deviceList);
        listView.setAdapter(deviceListAdapter);
